...
function ContactPage() {
    ...
    const handleOnClickInstagram = () => {
        window.open('https://www.instagram.com/jesusyouthchengaloor?igsh=MWo3OTE5ZXprenhldg==', '_blank');
    }
    const handleOnClickGitHub = () => {
        // window.open('https://github.com/christokj', '_blank');
    }
    const handleOnClickGmail = () => {
        window.open('https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&to=jychengaloor@gmail.com&subject=MISSED%20CALL%20EZTRADER&body=Hello%2C%0A%0APlease%20enter%20your%20message%20here%20', '_blank')
    }
    const handleOnClickLinkedin = () => {
        // window.open('https://linkedin.com/in/christo-kj-231932156', '_blank');
    }
    const handleOnClickFacebook = () => {
        window.open('https://www.facebook.com/JesusYouthChengaloor', '_blank');
    }
    ...
    return (
        <div className={`md:flex pt-24 py-10 min-h-screen bg-gradient-to-br  from-blue-100 via-purple-200 to-pink-100 `}>
                    ...
                    <div className='pt-5'>
                        ...
                        <div className="flex justify-center space-x-4 mt-3">
                            <Github
                                ...
                                size={66}
                                className='cursor-pointer mx-2 my-4 hover:text-black hover:bg-white hover:rounded-full hover:w-[80px] hover:h-[80px] transition-all duration-200'
                            />
                            ...
                            <Linkedin
                                ...
                                size={66}
                                className='text-gray mx-2 my-4 rounded-full cursor-pointer hover:text-[#0a66c2] hover:bg-white hover:w-[80px] hover:h-[80px] transition-all duration-200'
                            />
                        </div>
                        <div className="flex justify-center space-x-4 mt-3 ms-4">
                            <Facebook
