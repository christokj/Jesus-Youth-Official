...
function AdminHomepage() {
    ...
    const downloadPDF = () => {
        ...
        const tableColumn = [
            'Name', 'Age', 'Unit', 'Address', 'Mobile',
            'Place', 'Marital Status', 'DOB', 'Parish'
        ];
        const tableRows = students.map(student => ([
            student.name, student.age, student.unit, student.address,
    ...
    const deleteStudent = async (fullname, place, dob) => {
        try {
            await axiosInstance.delete('/admin/delete-student', {
                data: { name: fullname, place, dob },
            });
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6 pt-16">
            ...
            <div className="flex justify-between items-center max-w-6xl mx-auto mb-6">
                ...
                <div>
                    <button onClick={logout} className="btn btn-primary btn-outline btn-sm normal-case mx-4">
                        Logout
                    </button>
                ...
                {students.map((student, index) => (
                    <div key={index} className="bg-white shadow-md rounded-2xl p-6 hover:shadow-xl transition-all">
                        <div className="flex justify-between items-start">
                            ...
                            <button
                                onClick={() => deleteStudent(student.name, student.place, student.dob)}
